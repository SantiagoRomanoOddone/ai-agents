...
# The function simulates sending an email by printing it to the console. In a real application, 
# change it to a SMTP service or similar to actually send the email!
class EmailPlugin:
